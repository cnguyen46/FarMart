...
public class DataConverterUtils {
	...
	/**
	 * This method is used to convert the <code>HashMap<<code>String, T> into the List
	 * 
	 * @param <T>
	...
	public static <T> List<T> convertMapWithKeyString(HashMap<String, T> hashMapData) {
	...
	/**
	 * This method is used to convert the <code>HashMap<<code>Integer, T> into the List
	 * 
	 * @param <T>
	 * @param hashMapData<Integer, T>
	 * @return List<T>
	 */

	public static <T> List<T> convertMapWithKeyInteger(HashMap<Integer, T> hashMapData) {

		List<T> listData = new ArrayList<>();
		for (Integer str : hashMapData.keySet()) {
			listData.add(hashMapData.get(str));
		}
		return listData;
	}
	...
	/**
	 * This method is used to convert the data into the JSON file for {@link MainMethods#DataConverter()}
	 * 
	 * @param <T>
	 * @param listData
	 * @param fileName
	...
	public static <T> void convertToJson(List<T> listData, String fileName) {
		...
		if (listData.get(0) instanceof Person && fileName.equals("data/Persons.json")) {
			...
			throw new IllegalArgumentException("You output the file to the wrong folder, or use wrong name for data file");
		}
	}
	
	/**
	 * This method is used to convert the data into the XML file {@link MainMethods#DataConverter()}
	 * 
	 * @param <T>
	 * @param listData
	 * @param fileName
