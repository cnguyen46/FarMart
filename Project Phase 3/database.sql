...
create table if not exists Person (
    ...
    constraint `uniquePerson` unique index(personCode)
);
...
create table if not exists Item (
    ...
    unitPrice float,
    hourlyRate float,
    constraint `uniqueItem` unique index(itemCode),
...
create table if not exists Store (
	...
	foreign key (addressId) references Address(addressId),
    constraint `uniqueStore` unique index(storeCode)
);
...
create table if not exists Invoice (
    ...
    constraint `uniqueInvoice` unique index(invoiceCode)
);
...
INSERT INTO Email (personId, userName) VALUES
    ...
    (4,'skyrimBelongtotheNord666@gmail.com');

# Reece Haggerwood
INSERT INTO Email (personId, userName) VALUES	
    (5, 'rhaggerwood4@histats.com'),
	(5, 'potteralex457@red.com');

# Amy Jenton
INSERT INTO Email (personId, userName) VALUES
    (6, 'ajenton5@eepurl.com'),
	(6, 'potteralex457@yahoo.com'),
	(6, 'gerad.Harad1009@that.com'),
...
# Elsbeth Reveley
INSERT INTO Email (personId, userName) VALUES
	(8, 'ereveley6@upenn.edu'),
	(8, 'gerad.Harad1009@this.com');
...
# Berk Meanwell
INSERT INTO Email (personId, userName) VALUES
	(10, 'bmeanwell8@parallels.com'),
	(10, 'sjlkThesia@hmail.com');
 
# Prentiss Dungey
INSERT INTO Email (personId, userName) VALUES
	(11, 'pdungey9@hubpages.com'),
	(11, 'tobeOrnottoBe1092@engineering.com'),
	(11, 'nowhere134@gmail.com'),
	(11, 'universal76forthis09@haha.com');
    
# Hermia Bunford
INSERT INTO Email (personId, userName) VALUES
	(12, 'hbunforda@businesswire.com'),
	(12, 'thisisit918@yahoo.com');
 
# Nollie Blesdil
INSERT INTO Email (personId, userName) VALUES
	(13, 'nblesdillb@harvard.edu'),
	(13, 'iamNotaBot9018@facebook.com');
